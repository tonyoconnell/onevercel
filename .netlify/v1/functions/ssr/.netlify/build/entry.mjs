...
import { manifest } from './manifest_BAKiPtWj.mjs';
...
const _page3 = () => import('./pages/chat-icon.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/chat-icon.astro", _page3],
...
const _args = {
    "middlewareSecret": "6af57647-fb93-459c-b286-e10338f2cb1f"
};
